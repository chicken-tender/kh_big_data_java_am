...
// 이름, 나이, 성별, 직업 받아서 출력 하기
// return:호출한 함수로 되돌아감
public class MemberInfo { // 클래스 안에는 필드와 메소드가 있음
    ...
    public void setAge() {
        while (true) {
            ...
            age = sc.nextInt();
            if(age > 0 && age < 200) return; // break: 반복문의 블록을 벗어나는 것
    ...
    // setGender()에서 입력을 char로 받았기 때문에 int로 받는 함수 하나 더 생성.
    ...
    public void viewInfo() {
        String[] genderStr = {"", "남성", "여성"}; // 배열은 0부터 시작하기 때문에 0은 ""로 대체..
