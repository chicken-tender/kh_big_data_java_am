package 문자열다루기0109;
// equals 메소드 : 두개의 문자열이 동일한지 비교하여 결과값 return
public class StringType {
    public static void main(String[] args) {
        ...
        System.out.println(a == c); // 문자열의 내용을 비교하는 것이 아니고, 문자열의 참조. 즉 주소 비교
        ...
        // replaceAll : 문자열 중 특정 문자열을 다른 문자열로 대체할 때 사용, 정규식도 가능..
        ...
        System.out.println(e.substring(6,9)); // 시작 인덱스부터 종료 인덱스 미만까지 추출
