...
// 추상클래스? 실체가 없는 부모가 상속을 주는 것
// 추상클래스에는 반드시 추상 메소드가 포함되어야 하고, 해당 메소드는 상속 받은 자식 클래스에서 반드시 구현해줘야 함.(오버라이딩)
...
abstract class Animal {
    abstract void cry(); // 추상 메소드는 abstract 키워드를 사용하고, 반드시!!!! 세미콜론으로 끝나야 함.
    // {} 가 없다는건 구현부가 없다는 뜻, 즉 추상화
}
